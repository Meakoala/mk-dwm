...
static const char *fonts[]          = {
    "Tlwg TypeWriter:pixelsize=15:style=Bold:antialias=true:autohint=true",
    "Symbols Nerd Font Mono:style=Regular:antialias=true:autohint=true:pixelsize=15" 
}; 
static const char col_bgnorm[]      = "#222222";
static const char col_bbnorm[]      = "#444444";
static const char col_fgnorm[]      = "#bbbbbb";
static const char col_fgsel[]       = "#eeeeee";
static const char col_bbsel[]       = "#443377";
static const char col_bgsel[]       = "#443377";
static const char *colors[][3]      = {
    /*               fg         bg         border   */
    [SchemeNorm] = { col_fgnorm,col_bgnorm,col_bbnorm},
    [SchemeSel]  = { col_fgsel, col_bgsel, col_bbsel },
};

static const char *const autostart[] = {
    "picom", "-CGb", "--experimental-backend", NULL,
    "sh", "-c", "$HOME/Documents/Github/suckless/dwm/scripts/dbus", NULL,
    "syncthing", NULL,
    "dwmblocks", NULL,
    "urxvtd", NULL,
    "/home/kia/bin/activitywatch/aw-qt", NULL,
    "flameshot", NULL,
    "nitrogen", "--set-zoom-fill", "--random", "/home/kia/Pictures/backgrounds/", NULL,
    "dbus-run-session", "/usr/bin/flatpak", "run", "com.discordapp.Discord", NULL,
    "snap", "run", "bitwarden", NULL,
    "megasync", NULL,
    "lxpolkit", NULL,
    NULL /* terminate */
};
...
static const Key keys[] = {
	...
	{ MODKEY|Mod4Mask,              XK_asterisk,      togglegaps,     {0} },
	{ MODKEY|Mod4Mask|ShiftMask,    XK_asterisk,      defaultgaps,    {0} },
